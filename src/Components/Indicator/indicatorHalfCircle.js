...
function IndicatorHalfCircle({percentage, tittleStyle, valueStyle, unitStyle, rawValue, activeAlarm, size}) {
    return (
        <div className='indicator-container' style={{width : size * 2, height : size}}>
            ...
            <div className='indicator-customLoc-rotate' style={{'--topPos' : 21, '--leftPos' : 46, '--needleRot': getRotation(0)}}>
            ...
            <div className='indicator-TitleText' style={{fontSize: 20, fontWeight: 'bold'}}> {'Hz'} </div>
